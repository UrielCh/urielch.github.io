...
| UI |[reganam](https://github.com/UrielCh/reganam)                                                 | An OVH-Cloud dashboard                       | convert to Typsecript to plug it to my OVH-Cloud API, and test React | No     |
| Admin |[alpine-ts](https://www.npmjs.com/package/alpine-ts)                                           | An apache log parser                         | convert to Typsecript + reduce bundle size + add features            | No     |
| Automation |[puppeteer-extra](https://www.npmjs.com/package/puppeteer-extra)                               | Plugins for puppeter                         | convert to Typsecript + adding features, PRs in progress...          | inProgress |
